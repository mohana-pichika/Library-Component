...
Libary extends  Library kernal (interface 1, Enhanced)
-- Libaray seconday impelemnts Libary
--Libaray kernal extends standard (Kernal interface)
--Library1L extends secondary
